        ...
        <div class="reservation">
            ...
            <div class="formulaire">
                <form method="post" action="ZE-Resa2.php">
                    <div id="Resa">
                        <input type="text" name="name" id="Nom" placeholder="Nom" size="40" required value="<?php echo $name; ?>/>
                        <br>
                        <input type=" text" name="name" id="Prenom" placeholder="Prénom" size="40" required />
                        <br>
